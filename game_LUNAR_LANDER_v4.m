...
%NOTES: 
% - AUTO MODE: Program an auto-landing algorithm into the game so the ship,
% regardless of randomly generated surfaces, can auto-land successfully
...
global right left button_on mars choose_exp main main_again exit
...
[bg_patch,xmoon,ymoon,moon_patch,star_p] = create_setting(bg,mars);
...
%% CREDITS SCREEN
uicontrol('Style','text','String','Thanks for playing game_Lunar_Lander_v4!',...
...
function [bg_patch,xmoon,ymoon,moon_patch,star_p] = create_setting(bg,mars)
